...
tree.so: tree.o rnni.o spr.o queue.o unlabelled_tree.o unlabelled_rnni.o
	gcc -shared -g -o tree.so tree.o rnni.o spr.o queue.o unlabelled_tree.o unlabelled_rnni.o
