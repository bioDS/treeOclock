...
tree.so: tree.o rnni.o spr.o unlabelled_tree.o unlabelled_rnni.o exploring_rnni.o
	gcc -shared -g -o tree.so tree.o rnni.o spr.o unlabelled_tree.o unlabelled_rnni.o exploring_rnni.o
