...
// i.e. tree.node_array[r].children[child_moves_up] has parent of rank r+1 after move
...
Tree_Array rnni_neighbourhood(Tree* tree){
    ...
    // 'ranks' here means position in node array, where the first n entries are leaves
